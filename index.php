      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href=".?id=contactme">Contact Info</a></li>
            <?php
            if($name==null)
            {
            echo"<li id='sign'><a>Sign In</a></li>";
      		echo "<div class='row' style='margin-left:0px;margin-right:0px;' id='form'>
		...
		<form class='form-inline' action='.?id=login' method='post'>
  		...
  		<input type='submit' class='btn btn-default' id='submit' value='Log In'>
		</form>
		</div>
		</div>";
		echo "<li><a href='.?id=signup'>Sign Up</a></li>";
	}
	else
		echo"<li id='signout'><a href='.?id=signout'>Sign Out</a></li>";
	?>
    	</ul>
        </div><!--/.nav-collapse -->
      </div>
